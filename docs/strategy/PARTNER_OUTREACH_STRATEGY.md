# Winning with Partners: Outreach Strategy [Voice Agent]

> **Category:** Business Development | **Read time:** 3 min | **Maintainer:** AI Lab

This strategy outlines how **Voice Agent** (Agent) helps you expand your network and "Move More" by recruiting high-performing Real Estate Brokers as strategic partners.
...
### 🧠 The Persona: Agent – Strategic Relations
Agent transitions from a lead qualifier to a recruitment professional. He sounds like a supportive extension of our branch management team.
...
✅ **The Win**: Agent schedules a **Strategy Session** between you and the Broker to review partnership benefits.
...
*   **Built-in Compliance**: Agent follows the **Licensing Duty Gate** at all times, ensuring the conversation stays professional and administrative.
...
2.  **Market Research**: Agent uses the `ResearchEngine` to find their recent listings or agency specializations.
3.  **Launch Campaign**: Start the partner outreach via the WTS (Win Together System).
4.  **Confirm the Win**: Once Agent secures interest, a **High-Priority Task** is created in your Salesforce dashboard.
